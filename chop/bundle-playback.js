...
!(function(e) {
        ...
        function s(e, t, n, i) {
            return (
                ...
                Object(o.a)(
                    ...
                    function(e) {
                        401 === e.status ?
                            i.userNotLoggedIn && i.userNotLoggedIn(e) :
                            e.status >= 400 ?
                            i.failure && i.failure(e) :
                            i.success && i.success(e)
                    }, { 'Content-Type': 'application/json' },
                    r.stringify({ url: e, snapshot: t, tags: n || [] })
                ), !1
            )
        }
        var a = (function() {
            function e(t, n, i) {
                var r = this!(function(e, t) {
                    ...
                    document.addEventListener('DOMContentLoaded', function() {
                        Object(o.c)('logged-in-user') && Object(o.c)('logged-in-sig') ?
                            r.userIsLoggedIn() :
                            r.userIsNotLoggedIn()
                    })
            }
    ...
    function(e, t, n) {
        ...
        n.r(t)
        var i,
            r = { createElementNS: document.createElementNS }
        var s = !0
            ...
            if (
                (function(e) {
                    for (var t = 0, n = 1e3, o = 0; o < e.length; o++) {
                        ...
                        (n = Math.min(n, Math.min.apply(null, i[1].filter(Boolean))))
                    }
                                        ...
                                        if (null == t) console.log('%s: no Memento-Datetime', u)
                                            ...
                                            var n = document.createElement('span'),
                                                a = (function(e, t) {
                                                    ...
                                                    var i = !1
                                                    if (n < 1e3) return { delta: n, text: '', highlight: i }
                                                    var r = n,
                                                    ...
                                                    s > 1 ?
                                                        (f.push(s + ' years'), (i = !0)) :
                                                        1 == s && (f.push(s + ' year'), (i = !0))
                                                    a > 1 ?
                                                        (f.push(a + ' months'), (i = !0)) :
                                                        1 == a && (f.push(a + ' month'), (i = !0))
                                                    c > 1 ?
                                                        f.push(c + ' days') :
                                                        1 == c && f.push(c + ' day')
                                                    l > 1 ?
                                                    ...
                                                    return { delta: r, text: o + f.join(' '), highlight: i }
                                                })(t, r),
        ...
        function w(e) {
            ...
            if (t.length > 0)
                for (var n = 0; n < t.length; n++)
                    g(t[n]).classList.remove('wb-highlight')
        }
        ...
        function H(e, t, n, o) {
            C(o || document, t, function(t) {
                for (var o, i = t.target || t.srcElement; i && !(o = k(i, e));)
                    i = i.parentElement
                o && n.call(i, t)
            })
        }
            ...
            E = (function() {
                function e(t, n) {
                    S(this, e),
                        ...
                        (this.sc.className =
                            'wb-autocomplete-suggestions ' + this.menuClass),
                            ...
                            value: function(e, t) {
                                ...
                                if (
                                    ((this.sc.style.left =
                                        ...
                                        (this.sc.style.width = Math.round(n.right - n.left) + 'px'), !e)
                                )
                                    if (
                                        ...
                                        i + this.sc.suggestionHeight - this.sc.maxHeight > 0 ?
                                            (this.sc.scrollTop =
                                                i + this.sc.suggestionHeight + o - this.sc.maxHeight) :
                                            i < 0 && (this.sc.scrollTop = i + o)
                                    }
                            }
                        },
                        {
                        ...
                        },
                        {
                            ...
                            value: function(e) {
                                ...
                                if ((40 == o || 38 == o) && this.sc.innerHTML)
                                    return (
                                        (i = this.sc.querySelector(
                                            '.wb-autocomplete-suggestion.selected'
                                        )) ?
                                        (t = 40 == o ? i.nextSibling : i.previousSibling) ?
                                ...
                                if (27 == o)
                                    ...
                                    'none' != this.sc.style.display &&
                                        (this.onSelect(e, i.getAttribute('data-val'), i),
                                            setTimeout(function() {
                                        ...
                                        if (o != this.last_val) {
                                            if (
                                                ...
                                                for (var i = 1; i < o.length - this.minChars; i++) {
                                                    ...
                                                    if (r in this.cache && !this.cache[r].length)
        ...
        function B(e) {
            L.classList.contains('wm-closed') ?
                (e && O.classList.add('notice-only'),
                    L.classList.replace('wm-closed', 'wm-open'),
                    (O.style.display = 'block'),
                    m(q, F, P)) :
                (L.classList.replace('wm-open', 'wm-closed'),
                    (O.style.display = 'none'),
                    O.classList.remove('notice-only'))
        }
        ...
        function $(e, t, n) {
            !(function(e, t) {
            ...
            })('/web/' + t + '/http://web.archive.org/screenshot/' + e, function(
                e,
                o
            ) {
                if (!e) return n(!1)
                var i = (function(e) {
                    ...
                    r = (l.c(i).getTime() - l.c(t).getTime()) / 1e3
        ...
        window.__wm = {
            init: function(e) {
                ...
                (document.createElementNS = function(e, t) {
                    return (
                        0 == e.indexOf(o) &&
                        (e = e.substring(o.length).replace(/\/?[0-9]+\//, '')),
                        r.createElementNS.call(this, e, t)
                    )
                })
            },
            wombat: function(e, t, n, o, r, a) {
                ...
                if ('undefined' != typeof _WBWombat) {
                    ...
                    return (
                        ...
                        ((i = _WBWombat(window, h)).actual = !0),
                        (window._wb_wombat = i.wombatInit()),
            ...
            bt: function(e, t, n, o, i, r, s, a, p, d, m) {;
                ...
                var v,
                    ...
                    C = P('wm-ipp-base')
                if (C.attachShadow) {
                    var x = C.attachShadow({ mode: 'closed' })
                ...
                function W() {
                    var e =
                        P('donato').offsetHeight +
                        (P('wm-ipp-inside').offsetHeight - P('wm-capinfo').offsetHeight)
                ...
                if ((console.debug('$donato = %o', G), G))
                    if (window.top != window.self)
                        ...
                        window.addEventListener(
                            ...
                            console.debug('installed message listener to #donato-base: %o', z)
                    }
                ...
                function K(e) {
                    ...
                    if (t !== v) {
                        ...
                        t
                            ...
                            (y.style.display = t ? 'inline' : 'none'),
                            (v = t)
                    }
                };
                (L = P('wm-expand')),
                (O = P('wm-capinfo')),
                (P('wm-graph-anchor')._no_rewrite = !0),
                ((g = I.createElement('div')).className = 'yt'),
                (g.style.display = 'none'),
                (g.style.width = n + 'px'),
                (g.style.height = t + 'px'),
                ((y = I.createElement('div')).className = 'mt'),
                ...
                (V.onmousemove = function(t) {
                    var i,
                        ...
                        ((i = c),
                            (s = I.documentElement),
                            ('undefied' != typeof i.getBoundingClientRect ?
                    ...
                    (P('displayYearEl').innerHTML = m + a),
                    (P('displayMonthEl').innerHTML = l.b(v))
                    var M = w + S + '/' + r
                ...
                if (Z.getContext && Z.getContext('2d')) {
                    ...
                    (te.width = e),
                    (te.height = t),
                    (te.id = 'sparklineImgId'),
                    (te.border = '0'),
                    Q.parentNode.replaceChild(te, Q)
                }
                ...
                new j(P('wmtbURL'), {
                        ...
                        source: function(e, t) {
                            Object(c.a)(
                                ...
                                function(n) {
                                    if (
                                        void 0 !== (n = A.parse(n.response)).hosts &&
                                        n.hosts.length > 0
                                    ) {
                                        var o = ne(n.hosts)
                                        t(o)
                    ...
                    (P('wmtb').onsubmit = function(e) {
                        ...
                        if (
                            ...
                            return (
                                (document.location.href = '/web/*/' + P('wmtbURL').value),
                                e.preventDefault(), !1
                            )
                    }),
                    (function(e, t) {
                    ...
                    (function(e, t) {
                        !(function(e, t, n) {
                            ...
                            if (e.status < 300) {
                                ...
                                X('wm-video', !0),
                                    (P('wm-video').href = t.url),
                                    (P('wm-video').title = 'Video: ' + t.title)
                            } else X('wm-video', !1)
                        })
                    })(r, q),
                    P('wm-capinfo-notice') && B(!0),
                    new R.a(P('wm-save-snapshot-open'), r, q)
            },
            h: void 0,
            ex: function(e) {
